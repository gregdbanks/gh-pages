...
class Rule {
  ...
  //  // this takes your dice array and gives you frequency for ex: freq([4,4,4,2,2]) -> freq([3,2])   <===============
  freq(dice) {
    // f-requencies of dice values
    const freqs = new Map();
...
class FullHouse extends Rule {
   evalRoll = dice => {
      ...
      //  To Be Clear: new Set will give back array with only unique values, for ex: [1,1,3,3,4] ---> 

     
      return (freqs.includes(2) && freqs.includes(3)) ? this.score : 0; // includes method belongs to Array.prototype
   }
}
...
const fullHouse = new FullHouse({ score: 25, description: '25 points for a fullhouse'});
